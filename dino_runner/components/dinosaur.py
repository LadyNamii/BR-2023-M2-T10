...
from dino_runner.utils.constants import RUNNING, JUMPING, DUCKING, DEFAULT_TYPE, SHIELD_TYPE, DUCKING_SHIELD, JUMPING_SHIELD, RUNNING_SHIELD, JUMPING_HAMMER, RUNNING_HAMMER, DUCKING_HAMMER, JUMP_SOUND
...
class Dinosaur(Sprite):
    ...
    def update(self, user_input):
        ...
        if user_input[pygame.K_UP] and not self.dino_jump or user_input[pygame.K_SPACE] and not self.dino_jump:
            ...
            self.dino_jump = True
            self.dino_duck = False
        elif user_input[pygame.K_DOWN] and not self.dino_jump or user_input[pygame.K_SPACE] and not self.dino_jump:
            self.dino_run = False
            self.dino_jump = False
            self.dino_duck = True
